...
// print each values.
    ...
    console.log("Name:" ,name ); //The output is Name:vikas
    console.log("Age:" , age);      //The output is Age:24
    console.log("Are You Learning JS?:" , LearningJS); //The output is LearningJS = true.
    console.log("Value is:",value);     //The output is  value:null.


// print type of each values.

console.log("Type of  Name:" ,name );       //The output is - Type of Name:vikas.
    console.log("Type of Age:" , age);      //The output is - Type of Age:24.
    console.log("Type of Are You Learning JS?:" , LearningJS);      //The output is - Type of LearningJS = true.
    console.log("Type of Value is:",value);     //the output is -- Type of Value:null.
...
user.age++;
console.log("Age after increment:", user.age);
